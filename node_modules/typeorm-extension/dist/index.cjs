...
async function findDataSource(context) {
    ...
    if (!context.preserveFilePaths && !isCodeTransformation(exports.CodeTransformation.JUST_IN_TIME)) {
        for(let j = 0; j < files.length; j++){
    ...
    for(let i = 0; i < files.length; i++){
        ...
        if (info) {
            ...
            if (defaultExport && typeorm.InstanceChecker.isDataSource(defaultExport.value)) {
